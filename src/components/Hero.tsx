...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden w-full">
      ...
      <div className="absolute bottom-0 left-0 right-0 bg-gray-100 py-4 sm:py-6 overflow-hidden w-full testimonial-strip">
        {/* Left fade gradient */}
        <div className="absolute left-0 top-0 bottom-0 w-16 sm:w-32 bg-gradient-to-r from-gray-100 via-gray-100/80 to-transparent z-10 pointer-events-none"></div>

        {/* Right fade gradient */}
        <div className="absolute right-0 top-0 bottom-0 w-16 sm:w-32 bg-gradient-to-l from-gray-100 via-gray-100/80 to-transparent z-10 pointer-events-none"></div>
      ...
      <div className="relative z-10 text-center max-w-5xl mx-auto px-4 sm:px-6 -mt-20">
        <h1 className="font-heading text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-black mb-4 sm:mb-6">

          <br />
          <span className="text-black font-windsolRegular italic">
            <span className="text-3xl sm:text-4xl md:text-5xl lg:text-[calc(1em-26px)]"> Forging <span className="underline text-gray-500">Content</span> That </span>
            <span className="italic font-windsolRegular relative text-primary text-3xl sm:text-4xl md:text-5xl lg:text-[calc(1em-26px)]">
              Builds
            </span>
          </span>
          ...
          <span className="text-black font-windsolRegular italic">
            ...
            <span className="italic font-windsolRegular relative text-black text-3xl sm:text-4xl md:text-5xl lg:text-[calc(1em-19px)]">
              Bank Accounts
        ...
        <p className="text-black text-xl sm:text-2xl md:text-3xl lg:text-2.5xl font-medium mb-6 sm:mb-8 max-w-4xl mx-auto leading-relaxed px-2">
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center mt-12 sm:mt-16">
          <Button
            ...
            className="border-primary text-primary hover:bg-primary hover:text-primary-foreground hover-glow px-8 sm:px-12 py-4 sm:py-6 text-xl sm:text-xl font-semibold transition-all duration-300 scale-100 sm:scale-125"
          >
            Get in Touch
          </Button>
        </div>
